...
export default function AdminPage() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      setStats({
        totalUsers: Array.isArray(u) ? u.length : (s?.totalUsers ?? 0),
        totalCampaigns: Array.isArray(c) ? c.length : (s?.totalCampaigns ?? 0),
                    ...
                    onClick={async () => {
                      try {
                        ...
                        await updateAdminSettings({
                          ...
                          weeklyDrawDay: settings.weeklyDrawDay,
                          weeklyDrawTime: settings.weeklyDrawTime,
                          urgencyBannerActive: settings.urgencyBannerActive,
                          urgencyBannerEndDate: settings.urgencyBannerEndDate,
                          registrationsOpen: settings.registrationsOpen,
                          minTicketPrice: settings.minTicketPrice,
                          maxTicketPerUser: settings.maxTicketPerUser,
                        });
