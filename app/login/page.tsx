      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col relative overflow-hidden bg-deep-blue">
        ...
        <div className="relative z-10 flex flex-col h-full p-12 xl:p-16">
          ...
          <div className="flex items-center gap-3 mb-16">
            <div className="w-12 h-12 rounded-xl bg-gold flex items-center justify-center shadow-lg shadow-gold/30">
              <span className="text-deep-blue font-black text-xl">W</span>
            </div>
            <div>
              <span className="text-white font-black text-xl tracking-tight">WINBIG</span>
              <span className="text-gold font-black text-xl"> AFRICA</span>
            </div>
          </div>
          ...
          <div className="flex-1 flex flex-col justify-center">
            <div className="mb-8">
              ...
              <p className="text-gray-400 text-lg max-w-md leading-relaxed">
                Join over 25,000 Nigerians already winning life-changing prizes. From cars to cash jackpots — your luck is waiting.
              </p>
            </div>

            {/* Social proof badges */}
            <div className="flex flex-wrap gap-4 mt-8">
              {['🏆 ₦2.5B+ Won', '👥 25K+ Players', '🔒 Secure & Fair'].map((badge) => (
                <div key={badge} className="flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-4 py-2">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <div className="bg-white rounded-2xl shadow-card p-8">
              <div className="text-center mb-8">
                <h2 className="text-2xl font-black text-deep-blue mb-1">Welcome back</h2>
                <p className="text-gray-500 text-sm">Sign in to your WINBIG account</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <Link href="/forgot-password" className="text-xs text-gold hover:underline font-medium">Forgot password?</Link>
                  </div>
              ...
              <p className="text-center text-sm text-gray-500 mt-6">
                ...
                <Link href="/register" className="text-gold font-semibold hover:underline">Create one free</Link>
              </p>
            </div>
          </motion.div>
        </div>
